...
class TestPrivateKeyPasswordValidation(unittest.TestCase):
    ...
    def test_password_length(self):
        self.assertEqual(
            check_valid_private_key_password("Abc123!")[1],
    ...
    def test_password_digit(self):
        self.assertEqual(
            check_valid_private_key_password("Abcdefghijk!")[1],
            "Password must contain at least one digit",
        )
        self.assertEqual(
            check_valid_private_key_password("ABCDEFGH1JK!")[1],
    ...
    def test_password_uppercase(self):
        ...
        self.assertEqual(
            check_valid_private_key_password("Abcdefgh1jkl")[1],
